...
import 'package:mymeattest/screens/productListScreen.dart';
...
class _SearchScreenState extends BaseRouteState {
                      ...
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (val) {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => ProductListScreen(7, val,
  ...
  List<Widget> _recentSearchWidget() {
    ...
    try {
      ...
      print("Exception - searchScreen.dart -  _recentSearchWidget():" +
          e.toString());
  ...
  _getRecentSearchData() async {
    try {
      ...
      print("Exception -  SearchScreen.dart - _getRecentSearchData():" +
          e.toString());
    }
  }
  ...
  _showTrendingSearchProducts() async {
    try {
      ...
      print("Exception -  searchScreen.dart - _showTrendingSearchProducts():" +
          e.toString());
    }
  }
  ...
  List<Widget> _trendingProductWidgetList() {
    ...
    try {
                      ...
                      child: Container(
                        child: CachedNetworkImage(
                          imageUrl: global.appInfo.imageUrl +
                              _trendingSearchProducts[i].productImage,
                          imageBuilder: (context, imageProvider) => Container(
                            ...
                            child: Visibility(
                              visible: _trendingSearchProducts[i].stock > 0
                                  ? false
                                  : true,
                              child: Container(
                                alignment: Alignment.center,
      ...
      _widgetList.add(SizedBox());
      print("Exception - homeScreen.dart - _trendingProductWidgetList():" +
          e.toString());
      return _widgetList;
    }
  }
