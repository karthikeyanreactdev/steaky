...
import 'package:mymeattest/screens/filterScreen.dart';
...
class _WishListScreenState extends BaseRouteState {
  ...
  Widget build(BuildContext context) {
    if (_wishListOutOfStockProductList != null &&
        _wishListOutOfStockProductList.length > 0) {
      _wishListOutOfStockProductList.clear();
    }
    _wishListOutOfStockProductList
        .addAll(_wishListProductList.where((e) => e.stock == 0));
    ...
    return SafeArea(
      child: Scaffold(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Stack(
                                          ...
                                          children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      RichText(
                                                          text: TextSpan(
                                                            ...
                                                            TextSpan(
                                                              text:
                                                                  '${_wishListProductList[index].price}',
                                                              style: Theme.of(
                                                                      context)
                                                                  .primaryTextTheme
                                                                  .bodyText1,
                                                            ...
                                                            TextSpan(
                                                              text:
                                                                  ' / ${_wishListProductList[index].quantity} ${_wishListProductList[index].unit}',
                                                              style: Theme.of(
                                                                      context)
                                                                  .primaryTextTheme
                                                                  .headline2,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  RichText(
                                                                    text:
                                                                        TextSpan(
                                                                      text:
                                                                          "${_wishListProductList[index].rating} ",
                                                                      style: Theme.of(
                                                                              context)
                                                                          .primaryTextTheme
                                                                          .bodyText1,
                                                                      children: [
                                                                        ...
                                                                        TextSpan(
                                                                          text:
                                                                              ' ${_wishListProductList[index].ratingCount} ${AppLocalizations.of(context).txt_ratings}',
                                                                          style: Theme.of(context)
                                                                              .primaryTextTheme
                                                                              .headline1,
                                                                        )
                                            ...
                                            _wishListProductList[index].stock >
                                                    0
                                                ? _wishListProductList[index]
                                                                .cartQty ==
                                                            null ||
                                                              ...
                                                              IconButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (isAdded) {
                                                                      _wishListProductList[
                                                                              index]
                                                                          .cartQty = _wishListProductList[index]
                                                                              .cartQty -
                                                                          1;
                                                                    }
                                                                    setState(
        ...
        bottomNavigationBar: _isDataLoaded &&
                _wishListProductList.length > 0 &&
                _wishListOutOfStockProductList.length !=
                    _wishListProductList.length
            ? Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: TextButton(
                          ...
                          child: Text(_wishListOutOfStockProductList != null &&
                                  _wishListOutOfStockProductList.length > 0
                              ? '${AppLocalizations.of(context).txt_add_all_instock_items}'
  ...
  _addAllProductToCart() async {
    try {
      ...
      if (isConnected) {
        ...
        await apiHelper.addWishListToCart().then((result) async {
          if (result != null) {
            if (result.status == "1") {
              global.currentUser.cartCount =
                  global.currentUser.cartCount + _wishListProductList.length;
              _wishListProductList.clear();
              hideLoader();
      ...
      print("Exception - wishListScreen.dart - _addAllProductToCart():" +
          e.toString());
    }
  }
    ...
    try {
      ...
      if (isConnected) {
        if (_isRecordPending) {
          ...
          await apiHelper
              .getWishListProduct(page, _productFilter)
              .then((result) async {
            if (result != null) {
              if (result.status == "1") {
      ...
      print("Exception - wishListScreen.dart - _getWishListProduct():" +
          e.toString());
    }
  }
