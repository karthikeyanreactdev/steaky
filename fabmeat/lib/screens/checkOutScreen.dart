...
import 'package:mymeattest/models/addressModel.dart';
...
import 'package:mymeattest/models/cartModel.dart';
import 'package:mymeattest/models/membershipStatusModel.dart';
import 'package:mymeattest/models/orderModel.dart';
import 'package:mymeattest/models/timeSlotModel.dart';
import 'package:mymeattest/screens/addAddressScreen.dart';
import 'package:mymeattest/screens/couponListScreen.dart';
import 'package:mymeattest/screens/loginScreen.dart';
import 'package:mymeattest/screens/memberShipScreen.dart';
import 'package:mymeattest/screens/paymentGatewayScreen.dart';
...
class _CheckoutScreenState extends BaseRouteState {
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: IconButton(
                onPressed: () {
                  if (_currentIndex == 0) {
                    print(global.currentUser.cartCount);
  ...
  Future deleteConfirmationDialog(int index) async {
    try {
      ...
      print("Exception - checkOutScreen.dart - deleteConfirmationDialog():$e");
      return false;
    }
  }
  ...
  Future<bool> _addToCart(int qty, int varientId, int special,
    ...
    try {
      ...
      print("Exception - checkOutScreen.dart - addToCart():$e");
      return _isAddedSuccesFully;
    }
  }
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${_cart.productList[index].description}',
                                          style: Theme.of(context)
                                              .primaryTextTheme
                                              .headline2,
                                          overflow: TextOverflow.ellipsis,
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    '${_cart.productList[index].gross_wt}',
                                                style: Theme.of(context)
                                                    .primaryTextTheme
                                                    .bodyText1,
                                              ),
                                            ...
                                            RichText(
                                              ...
                                              text: TextSpan(
                                                ...
                                                children: [
                                                  TextSpan(
                                                    text:
                                                        ' ${global.appInfo.currencySign} ${_cart.productList[index].price}   ',
                                                    style: Theme.of(context)
                                                        .primaryTextTheme
                                                        .bodyText1,
                                                  ),
  ...
  _checkMembershipStatus() async {
    try {
      ...
      print("Exception - checkOutScreen.dart - _checkMembershipStatus():$e");
    }
  }
  ...
  _getAddressList() async {
    try {
      ...
      print("Exception - checkOutScreen.dart - _getAddressList():$e");
    }
  }
          ...
          if (result != null) {
            if (result.status == "1") {
              ...
              global.currentUser.cartCount =
                  _cart.totalItems; //_cart.productList.length;
            }
          }
        });
      } else {
  ...
  _getRewardLines(String cartId) async {
    try {
      ...
      print("Exception - checkOutScreen.dart - _getRewardLines():  $e");
    }
  }
  ...
  _getTimeSlot() async {
    try {
      ...
      print("Exception - checkOutScreen.dart - _getTimeSlot():$e");
    }
  }
  ...
  _init() async {
    try {
      ...
      print("Exception - checkOutScreen.dart - _init():$e");
    }
  }
  ...
  Future<bool> _makeOrder() async {
    ...
    try {
      ...
      print("Exception - checkOutScreen.dart - _makeOrder():  $e");
  ...
  _removeAddress(int index) async {
    try {
      ...
      print("Exception - checkOutScreen.dart - _removeAddress():$e");
    }
  }
  ...
  _selectAddress() async {
    try {
      ...
      print("Exception - checkOutScreen.dart - _selectAddress(): $e");
    }
  }
  ...
  Widget _shimmerWidget() {
    try {
      ...
      print("Exception - checkOutScreen.dart - _shimmerWidget():$e");
      return SizedBox();
    }
  }
  ...
  List<Widget> _timeSlotWidget() {
    ...
    try {
      ...
      print("Exception - checkOutScreen.dart - _timeSlotWidget():$e");
      return _widgetList;
    }
  }
      ...
      child: Column(
        children: [
          ...
          _isClosingTime == false &&
                  ...
                  DateTime.now()
                      .isBefore(_closingTime.subtract(Duration(hours: 1)))
              ? _membershipStatus.status != 'running'
                  ? InkWell(
                      onTap: () async {
