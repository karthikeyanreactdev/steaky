import 'package:mymeattest/models/bannerModel.dart';
  ...
  HomeModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      whatsnewProductList = json['whatsnew'] != null
          ...
          : [];
      dealProductList = json['dealproduct'] != null
          ? List<Product>.from(
      ...
      print("Exception - homeModel.dart - HomeApiModel.fromJson():" +
          e.toString());
    }
  }
}
