...
class CurrentUser {
  ...
  CurrentUser.fromJson(Map<String, dynamic> json) {
    try {
      ...
      userImage = json['user_image'] != null && json['user_image'] != 'N/A'
          ? json['user_image']
          : null;
      userCity = json['user_city'] != null
          ? int.parse(json['user_city'].toString())
          : null;
      userArea = json['user_area'] != null
          ? int.parse(json['user_area'].toString())
          : null;
      otpValue = json['otp_value'] != null ? json['otp_value'] : null;
      status =
          json['status'] != null ? int.parse(json['status'].toString()) : null;
      wallet = json['wallet'] != null
          ? double.parse(json['wallet'].toString()).round()
          : null;
      rewards = json['rewards'] != null
          ? int.parse(json['rewards'].toString())
          : null;
      isVerified = json['is_verified'] != null
          ? int.parse(json['is_verified'].toString())
          : null;
      block =
          json['block'] != null ? int.parse(json['block'].toString()) : null;
      regDate = json['reg_date'] != null ? json['reg_date'] : null;
      appUpdate = json['app_update'] != null
          ? int.parse(json['app_update'].toString())
          : null;
      facebookId = json['facebook_id'] != null ? json['facebook_id'] : null;
      referralCode =
          json['referral_code'] != null ? json['referral_code'] : null;
      membership = json['membership'] != null
          ? int.parse(json['membership'].toString())
          : null;
      memPlanStart =
          json['mem_plan_start'] != null ? json['mem_plan_start'] : null;
      memPlanExpiry =
          json['mem_plan_expiry'] != null ? json['mem_plan_expiry'] : null;
      ...
      cartTotal = json['cartTotal'] != null
          ? int.parse(json['cartTotal'].toString())
          : 0;
    } catch (e) {
      print("Exception - userModel.dart - CurrentUser.fromJson():" +
          e.toString());
    }
  }
