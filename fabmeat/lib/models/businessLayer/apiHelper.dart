...
import 'package:mymeattest/models/aboutUsModel.dart';
...
import 'package:mymeattest/models/appSettingModel.dart';
import 'package:mymeattest/models/businessLayer/dioResult.dart';
import 'package:mymeattest/models/businessLayer/global.dart' as global;
import 'package:mymeattest/models/cancelReasonModel.dart';
...
import 'package:mymeattest/models/chatStoreModel.dart';
import 'package:mymeattest/models/cityModel.dart';
import 'package:mymeattest/models/couponModel.dart';
...
import 'package:mymeattest/models/membershipModel.dart';
import 'package:mymeattest/models/membershipStatusModel.dart';
import 'package:mymeattest/models/messageModel.dart';
import 'package:mymeattest/models/nearStoreModel.dart';
import 'package:mymeattest/models/notificationModel.dart';
import 'package:mymeattest/models/orderModel.dart';
import 'package:mymeattest/models/paymentGatewayModel.dart';
import 'package:mymeattest/models/productDetailModel.dart';
import 'package:mymeattest/models/productFilterModel.dart';
import 'package:mymeattest/models/rateModel.dart';
import 'package:mymeattest/models/recentSearchModel.dart';
import 'package:mymeattest/models/societyModel.dart';
import 'package:mymeattest/models/streamFormatter.dart';
import 'package:mymeattest/models/subModel.dart';
import 'package:mymeattest/models/termsOfServiceModel.dart';
import 'package:mymeattest/models/timeSlotModel.dart';
import 'package:mymeattest/models/userModel.dart';
import 'package:mymeattest/models/walletModel.dart';
...
class APIHelper {
  ...
  Future<dynamic> getproductSearchResult(
    ...
    try {
      ...
      dynamic recordList;
      if (response.statusCode == 200 && response.data["status"] == '1') {
        recordList = List<SubModel>.from(
            response.data["data"].map((x) => SubModel.fromJson(x)));
      } else {
        recordList = null;
      }
      return getDioResult(response, recordList);
