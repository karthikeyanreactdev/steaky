import 'package:mymeattest/models/subcategoryModel.dart';
  ...
  Category.fromJson(Map<String, dynamic> json) {
    try {
      ...
      storeId = json["store_id"] != null
          ...
          : null;
      startFrom =
          json['stfrom'] != null ? int.parse(json['stfrom'].toString()) : null;
      subcategoryCount = json['subcat_count'] != null
          ? int.parse(json['subcat_count'].toString())
          : 0;
      ...
      print("Exception - categoryModel.dart - Category.fromJson():" +
          e.toString());
    }
  }
}
